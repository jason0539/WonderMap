 ...
 * @author Jeff Gilfelt
 */
public class BadgeViewForButton extends TextView {
	...
	public BadgeViewForButton(Context context) {
		this(context, (AttributeSet) null, android.R.attr.textViewStyle);
	}
	
	public BadgeViewForButton(Context context, AttributeSet attrs) {
     ...
     */
	public BadgeViewForButton(Context context, View target) {
     ...
     */
	public BadgeViewForButton(Context context, TabWidget target, int index) {
		this(context, null, android.R.attr.textViewStyle, target, index);
	}
	
	public BadgeViewForButton(Context context, AttributeSet attrs, int defStyle) {
		this(context, attrs, defStyle, null, 0);
	}
	
	public BadgeViewForButton(Context context, AttributeSet attrs, int defStyle, View target, int tabIndex) {
