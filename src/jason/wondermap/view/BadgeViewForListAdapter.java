...
public class BadgeViewForListAdapter extends TextView {

    private boolean mHideOnNull = true;

    public BadgeViewForListAdapter(Context context) {
        this(context, null);
    }

    public BadgeViewForListAdapter(Context context, AttributeSet attrs) {
        this(context, attrs, android.R.attr.textViewStyle);
    }

    public BadgeViewForListAdapter(Context context, AttributeSet attrs, int defStyle) {
