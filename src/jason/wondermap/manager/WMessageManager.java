...
public class WMessageManager implements EventListener {
	...
	// ＝＝＝＝＝＝＝＝＝＝＝＝模式化代码＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝
	private static WMessageManager instance = null;
	private Context mContext;

	private WMessageManager() {
	...
	public static WMessageManager getInstance() {
		if (instance == null) {
			instance = new WMessageManager();
		}
		return instance;
	}
}
